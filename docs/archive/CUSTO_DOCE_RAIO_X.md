...
| **Nota** | **9.3/10** (atualizado 2026-07-06; era 9.0/10 em 30/06) — Schema manifest rico, 97 parametrized tests de validação, test_services decomposto em 21 módulos (era 13), 1419 tests (era 729) passing. 0 erros/warnings/skips. |
