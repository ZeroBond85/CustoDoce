...
> Última atualização: 2026-07-08 21:37 UTC

![Build Status](https://img.shields.io/github/actions/workflow/status/CustoDoce/ci.yml?branch=master)
![Version](https://img.shields.io/badge/version-20.699.94--mvp-blue)
...
- 📊 **Dashboard Analítico**: 20 módulos especializados incluindo visão geral, histórico de preços, ranking de fontes, promoções, insights de outliers e health de scrapers.
...
- [x] **Sprint 10.5 (sync_docs v2)**: 5 módulos baseados em markdown-it para classificação heading-aware de stale refs (HISTORICAL/CURRENT/AMBIGUOUS). 19 matches analisados, 5 auto-corrigidos. 993 testes unitários. Flag `--sync`/`--analyze`. Lição #25 (novo código = novos testes).
