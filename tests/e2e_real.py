...
def check_for_errors(app, context="", take_screenshot=True, page=None):
    ...
    error_selectors = [
        ".stAlert", ".stException",
        "text=st.error", "text=st.exception",
        "text=Traceback", "text=traceback",
        "text=column", "text=does not exist",
        "text=DatabaseError", "text=OperationalError",
        "text=42P10", "text=23505", "text=22P02",
        "text=Error:", "text=Erro:",
    ]
