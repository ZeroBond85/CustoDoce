    ...
    def extract(self, image_bytes: bytes) -> VisionResult | None:
        ...
        try:
            ...
            if resp.status_code == 429:
                logger.warning("[%s_vision] Rate limited", self.provider_name)
                self.record_failure()
                return None
...
def _safe_parse(content: str) -> VisionResult | None:
    ...
    try:
        ...
        return VisionResult(products=products, raw_text=raw_text, provider="")
...
class GroqVisionStrategy(VisionStrategy):
    ...
    def __init__(self):
        ...
        self.model = os.environ.get("GROQ_VISION_MODEL", "llama-3.2-90b-vision-preview")
...
class OpenRouterVisionStrategy(VisionStrategy):
    ...
    def __init__(self):
        ...
        self.model = os.environ.get("OPENROUTER_VISION_MODEL", "google/gemini-flash-1.5")
